        ...
        {previewImage ? (
          <div>
            ...
            <div className='button'>
              <p className='text-white-600'>change photo</p>
            </div>
            {/* <div className='button'>
              <a href="/compare"><p className='text-white-600'>Next --&gt;</p></a>
            </div> */}
          </div>
        ) : (
          <>
            <div className='button'>
              <p className='text-white-600'>choose photo</p>
            </div>
          </>
        )}
        {previewImage && (
          <div className='button'>
            <Link to="/selfie"><p className='text-white-600'>Next --&gt;</p></Link>
            </div>
            )}
